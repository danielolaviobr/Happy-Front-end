...
export default function CreateOrphanage() {
  ...
  function handleRemoveImage(image: string) {
    ...
    const imagesPreview = [...previewImages];

    // const selectedImagePreview = image;

    const imageIndex = imagesPreview.indexOf(image);
